...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [id_blad], [produkt], [typ_bledu], [warstwa], [kod_bledu], [tytul], [data_otwarcia], [data_zamkniecia], [SLA] FROM [blad_Wszystkie]"></asp:SqlDataSource>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyNames="id_blad" DataSourceID="SqlDataSource1" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        <Columns>
            <asp:BoundField DataField="id_blad" HeaderText="Id błędu" ReadOnly="True" SortExpression="id_blad" />
            ...
            <asp:BoundField DataField="data_zamkniecia" HeaderText="Data zamknięcia" SortExpression="data_zamkniecia" />
