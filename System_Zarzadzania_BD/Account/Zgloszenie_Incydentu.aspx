...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr><td>Kod klienta</td><td><asp:TextBox ID="id_klient" runat="server" TextMode="Number"></asp:TextBox><asp:TextBox ID="UserID" runat="server" TextMode="MultiLine"></asp:TextBox></td></tr>
        <tr><td>Produkt</td><td><asp:DropDownList ID="id_produkt" runat="server" DataSourceID="SqlDataSource1" DataTextField="nazwa" DataValueField="id_produkt"></asp:DropDownList>
        ...
        <tr><td>Tytuł</td><td><asp:TextBox ID="tytul" runat="server" TextMode="MultiLine"></asp:TextBox></td></tr>
        <tr><td>Opis</td><td><asp:TextBox ID="opis" runat="server" TextMode="MultiLine"></asp:TextBox></td></tr>
    </table>
